...
func main() {
	...
	db_connection := "user=postgres dbname=chicago_business_intelligence password=root host=/cloudsql/chicago-buisness-intelligence:us-central1:mypostgres sslmode=disable port = 5432"
